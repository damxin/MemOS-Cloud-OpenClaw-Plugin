...
export function buildConfig(pluginConfig = {}) {
  ...
  return {
    ...
    sharedScopeTag: cfg.sharedScopeTag ?? loadEnvVar("MEMOS_SHARED_SCOPE_TAG") ?? "",
    defaultScope: cfg.defaultScope ?? loadEnvVar("MEMOS_DEFAULT_SCOPE") ?? "",
    ...
    disableUpdateCheck: cfg.disableUpdateCheck === true || loadEnvVar("MEMOS_DISABLE_UPDATE_CHECK") === "true",
